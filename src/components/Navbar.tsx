...
function Navbar({}: Props) {
  return (
    <div className='w-full max-w-[100%] m-auto px-2 sm:px-2 lg:px-1 pt-10 pb-5 flex  justify-between font-light text-zinc-300 absolute top-0 z-20'>
        ...
        <motion.div initial={{opacity:0, y:100}} animate={{opacity:1, y:0}} transition={{ duration:1}}>
            <a href="/" className='z-50 flex items-center space-x-1'>
                ...
                <span className='font-bold text-5xl md:text-9xl text-white'>SPEAK.</span>
            </a>
        </motion.div>
        </div>
        <div className='max-md:hidden px-5  overflow-hidden'>
            <motion.div initial={{opacity:0, y:100}} animate={{opacity:1, y:0}} transition={{ duration:1}} className='flex items-center space-x-6 text-black' >
